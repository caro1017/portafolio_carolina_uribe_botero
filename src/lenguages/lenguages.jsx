...
export const languages = {
  es: {
    ...
    modalDownload: {
      thankYou: "¡ Gracias por tu interés en mi trabajo !",
      confirmation: "¿Deseas descargar el archivo?",
      observation: "* Se descargara un archivo en formato .pdf",
    },
    ...
    projects: [
      ...
      {
        id: uuidv4(),
        nameProjects: "Rediseño Nueva Mutua Sanitaria",
        description: "Rediseño pagina web, primera pagina. Servicio en salud",
        technology: ["Figma"],
        imgProjects: [Images.imgMutuaSanitaria],
        imgScreens: [Images.screenMutuaSanitaria],
        category: ["all", "design"],
        urlDemo: null,
        urlFigma:
          "https://www.figma.com/proto/rVzQIywnt0VdQvuyPKFoI8/Prueba-2_-Mimusa?type=design&node-id=18-1440&t=wB7pQD5WmDt8wLhN-0&scaling=scale-down&page-id=16%3A10602&starting-point-node-id=18%3A1440",
        urlGitHub: null,
      },

      {
        id: uuidv4(),
        nameProjects: "Rediseño Factor Libre",
        description:
          "Rediseño pagina web, web completa. Servicio venta Software Odoo",
        technology: ["Figma"],
        imgProjects: [Images.imgFactorLibre],
        imgScreens: [Images.screenFactorLibre],
        category: ["all", "design"],
        urlDemo: null,
        urlFigma:
          "https://www.figma.com/proto/X3XT5zQHWKuPcajJFGFcn1/Prueba-1---Mimusa?type=design&node-id=13-74&t=wB7pQD5WmDt8wLhN-0&scaling=scale-down&page-id=0%3A1&starting-point-node-id=13%3A74",
        urlGitHub: null,
      },
    ],
  },
  en: {
    ...
    modalDownload: {
      thankYou: "Thank you for your interest in my work!",
      confirmation: "Do you want to download the file?",
      observation: "* A file will be downloaded in .pdf format",
    },
    ...
    projects: [
      ...
      {
        id: uuidv4(),
        nameProjects: "Redesign Nueva Mutua Sanitaria",
        description: "Website redesign, first page. Health service",
        technology: ["Figma"],
        imgProjects: [Images.imgMutuaSanitaria],
        imgScreens: [Images.screenMutuaSanitaria],
        category: ["all", "design"],
      ...
      {
        id: uuidv4(),
        nameProjects: "Redesign Factor Libre",
        description:
          "Website redesign, complete website. Odoo Software Sales Service",
        technology: ["Figma"],
        imgProjects: [Images.imgFactorLibre],
        imgScreens: [Images.screenFactorLibre],
        category: ["all", "design"],
